...
describe('Raycaster instantiation', () => {
    test('object may not be instantiated with invalid resolutions', () => {
        expect(() => {
            new Raycaster(8.98, SIXTY_DEGREES, TEST_WIDTH, TEST_HEIGHT, TEST_DISTANCE, TEST_HORIZON_Y, TEST_WALL_HEIGHT, TEST_CAMERA_HEIGHT);
        }).toThrow();
        expect(() => {
            new Raycaster(-1, SIXTY_DEGREES, TEST_WIDTH, TEST_HEIGHT, TEST_DISTANCE, TEST_HORIZON_Y, TEST_WALL_HEIGHT, TEST_CAMERA_HEIGHT);
        }).toThrow();
    });
    test('object may not be instantiated with invalid angle for field of view', () => {
        expect(() => {
            new Raycaster(TEST_RESOLUTION, -1, TEST_WIDTH, TEST_HEIGHT, TEST_DISTANCE, TEST_HORIZON_Y, TEST_WALL_HEIGHT, TEST_CAMERA_HEIGHT);
        }).toThrow();
        expect(() => {
            new Raycaster(TEST_RESOLUTION, FULL_CIRCLE + 0.01, TEST_WIDTH, TEST_HEIGHT, TEST_DISTANCE, TEST_HORIZON_Y, TEST_WALL_HEIGHT, TEST_CAMERA_HEIGHT);
        }).toThrow();
    });
});
describe('getViewRays tests', () => {
    test('getViewRays should return a set with one ray per point of resolution', () => {
        const raycaster = new Raycaster(TEST_RESOLUTION, SIXTY_DEGREES, TEST_WIDTH, TEST_HEIGHT, TEST_DISTANCE, TEST_HORIZON_Y, TEST_WALL_HEIGHT, TEST_CAMERA_HEIGHT);
    ...
    test('getViewRays should return rays in order', () => {
        const raycaster = new Raycaster(TEST_RESOLUTION, NINETY_DEGREES, TEST_WIDTH, TEST_HEIGHT, TEST_DISTANCE, TEST_HORIZON_Y, TEST_WALL_HEIGHT, TEST_CAMERA_HEIGHT);
    ...
    test('no ray in result may exist outside the cone of vision: happy path', () => {
        const raycaster = new Raycaster(TEST_RESOLUTION, NINETY_DEGREES, TEST_WIDTH, TEST_HEIGHT, TEST_DISTANCE, TEST_HORIZON_Y, TEST_WALL_HEIGHT, TEST_CAMERA_HEIGHT); // 90 degrees field of view
...
describe('RemoveFishEye', () => {
    let raycaster;
    beforeEach(() => {
        raycaster = new Raycaster(TEST_RESOLUTION, SIXTY_DEGREES, TEST_WIDTH, TEST_HEIGHT, TEST_DISTANCE, TEST_HORIZON_Y, TEST_WALL_HEIGHT, TEST_CAMERA_HEIGHT);
    });
    ...
    test('removeFishEye should not apply to wide angles', () => {
        const raycaster = new Raycaster(TEST_RESOLUTION, SIXTY_DEGREES * 2, TEST_WIDTH, TEST_HEIGHT, TEST_DISTANCE, TEST_HORIZON_Y, TEST_WALL_HEIGHT, TEST_CAMERA_HEIGHT);
        const distance = 10;
...
describe('wallHeightToSliceHeight', () => {
    ...
    test('wallHeightToSliceHeight should return the height when distance is positive', () => {
        const raycaster = new Raycaster(TEST_RESOLUTION, NINETY_DEGREES, 640, TEST_HEIGHT, TEST_DISTANCE, TEST_HORIZON_Y, TEST_WALL_HEIGHT, TEST_CAMERA_HEIGHT); //control for a focal length
        const height = 10;
        const distance = 5;
